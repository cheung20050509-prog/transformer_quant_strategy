...
\vfill
\noindent{\footnotesize Project repository: \url{https://github.com/cheung20050509-prog/transformer_quant_strategy}}
...
\begin{enumerate}[leftmargin=2em]
    ...
    \item \textbf{Reproducibility:} The backtesting framework incorporates realistic transaction costs (commission, slippage, stamp tax), proper train/validation/test splitting, and benchmark comparison. All results are reproducible from the submitted code with fixed seeds. The project repository link is provided at the bottom of the first page.
\end{enumerate}
