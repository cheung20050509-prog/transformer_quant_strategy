...
\begin{enumerate}[leftmargin=2em]
    ...
    \item \textbf{Reproducibility:} The backtesting framework incorporates realistic transaction costs (commission, slippage, stamp tax), proper train/validation/test splitting, and benchmark comparison. All results are reproducible from the submitted code with fixed seeds.
\end{enumerate}
